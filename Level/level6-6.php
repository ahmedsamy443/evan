...
<div class="w3-top" >
    ...
    <!-- Navbar (sit on top) -->
        ...
        <a href="../Dashboard.php" class="w3-bar-item w3-button w3-padding-large w3-theme-d4" style="float:right;height:83px; padding-top: 9px !important;" >الرئيسية</a>
                <a href="../index6.html" class="w3-bar-item w3-button w3-padding-large w3-theme-d4" style="float:right ;height:83px; padding-top: 8px !important;">خروج</a>
    ...
    <div class="content" >
        <div class="btn">
        <a href="../PreTest2.html"  style="text-decoration: none;"><button  style="float:left; font-size: large; height:80px; width: 200px;background-image: url(btn.png);background-image: no-repeat;background-size: cover;margin-left:300px;cursor: pointer;"> الإختبار التحصيلي </button></a> 
        <a href="../PreTest2st.html"  style="text-decoration: none;"><button  style="float:left; font-size: large; height:80px;width:200px;background-image: url(btn.png);background-image: no-repeat;background-size: cover;margin-left:600px;cursor: pointer;"> مقياس الإنخراط في التعلم </button></a>
    </div> 
