...
<head runat="server">
    ...
    <title>المستوى الثالث | الاهداف التعليمية</title>
            ...
            <div class="w3-bar w3-green w3-padding w3-card text-center w3-center w3-centered ">
                ...
                <!-- <button class="w3-bar-item w3-button " onclick="window.open('/evan/levels/quest1_new.php','_self')" style="font-size: 25px;"> -->
                   ...
                   <!--<button class="w3-bar-item w3-button " onclick="shide('id01','id3','id3','id4','id5')" style="float:left;">الأهداف التعليمية</button>-->
                    ...
                    <a href="#" class="w3-bar-item w3-button w3-white" style="float:left; font-size: 25px;">المستوى الثالث </a>
                </div>
            </div>
        </div>
        <br />
    ...
    <div id="id01" class="w3-modal" dir='rtl' style="font-family: 'Droid Arabic Kufi';">
        <div class="w3-modal-content w3-card-4 w3-animate-zoom">
            <header class="w3-container w3-blue">
                ...
                <h2 style="padding-right: 40px">مستوى 3</h2>
            </header>
            ...
            <h2>الأهداف التعليمية</h2>
               ...
               <h3>
                   <ul>
                       <li>.يُعرف مفهوم المظاهر المختلفة للكائنات
                       </li>
                       <li>يَستعرض المظاهر المختلفة للكائنات فى برنامج Scratch.

                       </li>
                       <li>يٌبدل بين المظاهر المختلفة للكائنات فى برنامج Scratch.
.
                       </li>
                       <li>يٌحدد الفرق بين لبنة الارتداد ولبنة تغيير نمط الاتجاة فى مشروع فى برنامج Scratch .

                       </li>
                       <li>يٌحدد وظيفة التبويب Backdrop .

                       </li>
                       <li>يٌغير اتجاة الخلفية Backdropللمنصة Stageفى برنامج Scratch .

                       </li>
                       <li>يٌحدد وظيفة تبويب الصوت.

                       </li>
                       <li>يٌعرف مفهوم مجموعة الصوت.

                       </li>
                       <li>يَستخدم مجموعة لبنات الصوتSound فى مشروع فى برنامج Scratch.

                       </li>
                       <li>يٌرتب خطوات برمجة مشروع رسوم متحركة.
    ...
    <div id="id02" class="w3-modal" dir='rtl' style="font-family: 'Droid Arabic Kufi';">
        <div class="w3-modal-content w3-card-4 w3-animate-zoom">
            ...
            <br>
                <h3 align="center">عليك الحصول علي 50 نقطة فأكثر. <br>
            ...
            <button type="submit" name="submit" class="w3-btn w3-blue " onclick="window.open('/evan/levels/quest3_new.php','_self')" style="float:left; font-size: 20px;"> هيا للتحدي</button>    
        ...
        <div class="w3-col s9">
            <div class="card">
                ...
                <div id="id1" class="fakeimg" style="height: 200px; display: none">
                    <div class="w3-cell-row">
                        <div class="w3-container  w3-cell">
                            مرحباً بك 
                        <br />
                            المستوى الثالث يبدأ بـ<span style="color: blue">لعبة بسيطة</span>
                ...
                <div id="id2" class="fakeimg w3-center w3-centered" style="height: 200px">
                   ...
                   <br />
                    <h3>
                    أمامك مقطع فيديو ، تستطيع من خلاله التعرف على استخدام المظاهر المختلفة للكائنات ومجموعة الأصوات فى إنتاج صور ورسوم متحركة.
                    </h3>
                ...
                <div id="id3" class="fakeimg" style="height: 200px; display: none">
                    ...
                    <br />
                     نشاط 3 : مهمة3. عليكم الحصول على 25 نقطة فأكثر.أمامكم 25 دقيقة لنهاية التحدي.

                    <div >
                    <h1>قم بتحريك الكائن AZhip-hop على المنصة ذهاباً وإياباً كما بالشكل التالى مع إضافة مؤثر صوتى يناسب مشروعك وحفظ المشروع باسم رسوم متحركة. </h1>
