...
<head runat="server">
    ...
    <title>المستوى الثاني | الاهداف التعليمية</title>
...
<body dir="rtl" onload="shide('id01','id3','id3','id4','id5')" style="font-family: 'Droid Arabic Kufi'; background-image: url('2back2.png'); background-repeat: no-repeat; background-size: cover">
            ...
            <div class="w3-bar w3-green w3-padding w3-card text-center w3-center w3-centered ">
                ...
                <!-- <button class="w3-bar-item w3-button " onclick="window.open('/evan/levels/quest1_new.php','_self')" style="font-size: 25px;"> -->
                   ...
                   <!--<button class="w3-bar-item w3-button " onclick="shide('id01','id3','id3','id4','id5')" style="float:left;">الأهداف التعليمية</button>-->
                    ...
                    <a href="#" class="w3-bar-item w3-button w3-white" style="float:left; font-size: 25px;">المستوى الثاني </a>
                </div>
            </div>
        </div>
        <br />
    ...
    <div id="id01" class="w3-modal" dir='rtl' style="font-family: 'Droid Arabic Kufi';">
        <div class="w3-modal-content w3-card-4 w3-animate-zoom">
            <header class="w3-container w3-blue">
                ...
                <h2 style="padding-right: 40px">مستوى 2</h2>
            </header>
            ...
            <h2>الأهداف التعليمية</h2>
               ...
               <h3>
                   <ul>
                   <li> يٌحدد مفهوماً صحيحاً لخلفية المنصة.
                       </li>
                       <li>يغير الخلفية Backdrop لمنصة Stage من خلال اشكال عديدة للخلفيات.
                       </li>
                       <li> يَفتح ملفاً فى برنامج scratch سبق إنشاؤه.
                       </li>
                       <li>يٌحدد مجموعة الاحداث فى برنامج سكراتش.
                       </li>
                       <li>يَستخدم مجموعة لبنات الاحداث فى مشروع فى برنامج scratch.
                       </li>
                       <li>يٌحدد مجموعة الحركة فى برنامج سكراتش.
                       </li>
                       <li>يَستخدم مجموعة لبنات الحركة فى مشروع فى برنامج scratch.
                       </li>
                        <li>يٌحدد وظيفة لبنة الانتظار Wait فى برنامج  Scratch.
                         </li>
                            <li>يٌحدد الفرق بين لبنة Repeat& ولبنة Forever من مجموعة Control.    </li>
                   </ul>
                   </h3>
    ...
    <div id="id02" class="w3-modal" dir='rtl' style="font-family: 'Droid Arabic Kufi';">
        <div class="w3-modal-content w3-card-4 w3-animate-zoom">
            ...
            <br>
                <h3 align="center">عليك الحصول علي 35 نقطة فأكثر. <br>
            ...
            <button type="submit" name="submit" class="w3-btn w3-blue " onclick="window.open('/evan/levels/quest2_new.php','_self')" style="float:left; font-size: 20px;"> هيا للتحدي</button>    
    ...
    <br />
    <div class="row">
        <div class="w3-col s3" style="padding-top: 65px; display: hidden;">
        ...
        <div class="w3-col s9">
            <div class="card">
                ...
                <div id="id1" class="fakeimg" style="height: 200px; display: none">
                    <div class="w3-cell-row">
                        <div class="w3-container  w3-cell">
                            مرحباً بك 
                        <br />
                            المستوى الثاني يبدأ بـ<span style="color: blue">لعبة بسيطة</span>
                ...
                <div id="id2" class="fakeimg w3-center w3-centered" style="height: 200px">
                   ...
                   <br />
                    <h1>
                    أمامك مقطع فيديو ، تستطيع من خلاله التعامل مع خلفية المنصة وأوامر مجموعة (الاحداث -الحركة –التحكم).         </h1>
                ...
                <div id="id3" class="fakeimg" style="height: 200px; display: none">
                    ...
                    <h1>الآن : وبعد أن شاهدت مقطع الفيديو ، بإمكانك تنفيذ المهمات الآتية بالتعاون مع مجموعتك:</h1>
                                    <h1> نشاط3: مهمة3.   عليكم الحصول على 35 نقطة فأكثر.أمامكم 30 دقيقة لنهاية التحدي .
</h1>
                    <div>
                        <h1>أولا : أدرج كائن "Parrot" .</h1>
                        <h2>1.	سحب لبنة تحرك 10 خطوات .<br />
                            2.	تحكم فى سرعة الكائن باستخدام لبنة انتظر لمدة (2) ثانية.<br />
                            3.	كرر حركة كائن "Parrot" 10 مرات.<br />
                        </h2>
                        <h1>ثانيا: أدرج الكائن "Parrot2" </h1>
                        <h2>1. سحب لبنة تحرك 10 خطوات مرتين،ثم غير القيمة إلى 20.<br />
                            2.	تحكم فى سرعة الكائن باستخدام لبنة انتظر لمدة (1) ثانية.<br />
                            3.	قم بتكرار حركة كائن" Parrot2 " حركة لا نهائية .<br />
                        </h2>
                        <h2>ثالثا:قم بإدراج خلفية مناسبة للمشروع.
                        </h2>
                        <h2>رابعاً:اختبر المشروع بالضغط على علامة العلم الأخضر.
                        </h2>
                        <h2>خامساً:قم بحفظ المشروع بإسم كائن " Parrot ".
                        </h2>
