...
<head runat="server">
    ...
    <title>المستوى الخامس | الاهداف التعليمية</title>
...
<body dir="rtl" onload="shide('id01','id3','id3','id4','id5')" style="font-family: 'Droid Arabic Kufi'; background-image: url('2back2.png'); background-repeat: no-repeat; background-size: cover">
            ...
            <div class="w3-bar w3-green w3-padding w3-card text-center w3-center w3-centered ">
                ...
                <!-- <button class="w3-bar-item w3-button " onclick="window.open('/evan/levels/quest1_new.php','_self')" style="font-size: 25px;"> -->
                   ...
                   <!--<button class="w3-bar-item w3-button " onclick="shide('id01','id3','id3','id4','id5')" style="float:left;">الأهداف التعليمية</button>-->
                    ...
                    <a href="#" class="w3-bar-item w3-button w3-white" style="float:left; font-size: 25px;">المستوى الخامس </a>
                </div>
            </div>
        </div>
        <br />
    ...
    <div id="id01" class="w3-modal" dir='rtl' style="font-family: 'Droid Arabic Kufi';">
        <div class="w3-modal-content w3-card-4 w3-animate-zoom">
            <header class="w3-container w3-blue">
                ...
                <h2 style="padding-right: 40px">مستوى 5</h2>
            </header>
               ...
               <h2>فى نهاية تدريس هذا المستوى ينبغي أن يكون التلميذ قادر على أن:-</h2>
                <br />
                   ...
                   <ul>
                       ...
                       <h2>يٌحدد مجموعة القلم فى برنامج سكراتش. </h2>
                        <h2> يَستخدم مجموعة لبنات القلم فى رسم أشكال هندسية. </h2>
                        <h2>  يستخدم القاعدة العامة عند رسم أى شكل هندسي.</h2>
                        <h2>يَذكر الشكل الناتج عن رسم الكائن القط scratch.</h2>
                       </li>
                   </ul>
    ...
    <div id="id02" class="w3-modal" dir='rtl' style="font-family: 'Droid Arabic Kufi';">
        <div class="w3-modal-content w3-card-4 w3-animate-zoom">
            ...
            <br>
                <h3 align="center">عليك الحصول علي 30 نقطة فأكثر. <br>
            أمامك 7 دقائق لنهاية التحدي
            <br>
            <br>
            </h3>
            ...
            <button type="submit" name="submit" class="w3-btn w3-blue " onclick="window.open('/evan/levels/quest5_new.php','_self')" style="float:left; font-size: 20px;"> هيا للتحدي</button>    
        ...
        <div class="w3-col s9">
            <div class="card">
                ...
                <div id="id1" class="fakeimg" style="height: 200px; display: none">
                    <div class="w3-cell-row">
                        <div class="w3-container  w3-cell">
                            مرحباً بك 
                        <br />
                            المستوى الخامس يبدأ بـ<span style="color: blue">لعبة بسيطة</span>
                ...
                <div id="id2" class="fakeimg w3-center w3-centered" style="height: 200px">
                   ...
                   <br />
                    <h3>
                    أمامك مقطع فيديو ، تستطيع من خلاله التعرف على كيفية استخدام مجموعة القلم فى رسم أشكال هندسية جديدة 
                    </h3>
                ...
                <div id="id3" class="fakeimg" style="height: 200px; display: none">
                    ...
                    <h1>   نشاط 5 : مهمه 5 عليكم الحصول على 35 نقطة فأكثر.أمامكم 35 دقيقة لنهاية التحدي.
                   </h1> 
                    <div >
                        <h2>قم بإستخدام برنامج سكراتش فى رسم دائرة وذلك بتنفيذ المهمات الآتية : </h2>
                        <h2> 1. حذف كائن القط سكراتش. </h2>
                        <h2>  2. ادرج كائن جديد( القلم pen ) من مكتبة البرنمج.</h2>
                        <h2>3.سحب لبنة اتجة نحو الاتجاة.</h2>
                        <h2>4. سحب لبنة وضع القلم.</h2>
                       <h2> 5. خصص اللون الأخضر لرسم القلم.</h2>
                         <h2> 6. قم بتغيير حجم الخط.</h2>
                        <h2> 7. سحب أمر الحركة وغير قيمته.</h2>
                      <h2> 8. خصص أمر الدوران وغير قيمتة.</h2>
                      <h2>9. سحب لبنة كرر وحدد القيمة. </h2>
                     <h2>10. اختبر المشروع بالضغط على العلم الأخضر.</h2>
                      <h2> 11.حفظ المشروع بإسم "رسم دائرة". </h2>
