...
if(scores>=40)
{
    ...
    '<img id="img_gold" src="../images/tqatm.jpg" style="height:400px;width:400px;">' +
    '</div>' +
    '<div class="row">' +
    ...
    '<input type="submit" name="Btn_return" value=" تسليم" id="Btn_return" class="btn btn-primary" style="font-size:XX-Large;"  onclick="hello();window.open(\'/evan/Level/level6-6.php\',\'_self\');">' +
    '</div>' +
    '</div>' +
    '</div>';
}    
...
function hello()
{
    ...
    if (scores >= 40) 
    {
        ...
        xmlhttp.open("GET", "query6.php?score=" + scores +  "&wimg=" + wimg +"", true);
        xmlhttp.send();
        // $.ajax(
        //     {
        //         type:"get",
        //         url:"query6.php?score="+scores+"&time="+time+"&wimg="+wimg,
        //         success:function()
        //         {
        //             window.open();
        //         }
