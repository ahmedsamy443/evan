...
<body dir="rtl"  style="font-family: 'Droid Sans Arabic';background-image:url(bac.png); background-image :no-repeat; background-size:cover; ">
       ...
       <div id="UpdateProgress1" style="display:none;">
        ...
        <nav class=" navbar-expand-lg  navbar navbar-dark bg-primary" style="font-family: 'Droid Sans Arabic'; font-size: x-large">
            <a class="navbar-brand" href="#" style="font-size: 30px;">المستوى : 1</a>
    ...
    function get_result()
     {
      ...
      if (retry==1)
      {
        ...
        var honortime = 5-time;
        //console.log(honortime)
         // console.log(last_score)
         $.ajax(
             {
                 type:"get",
                 url:"http://localhost/evan/levels/query.php?honor="+last_score+"&levelid="+1+"&remaingtime="+honortime,
...
'<input type="submit" name="btn_ans" value="عرض الأجوبة" id="btn_ans" class="btn btn-primary" onclick="window.open(\'sol1_new.php?a1=\'+ ans[0] +\'&a2=\'+ans[1] +\'&a3=\'+ans[2]+\'&a4=\'+ans[3]+\'&a5=\'+ans[4]+\'&a6=\'+ans[5]+\'&a7=\'+ans[6]+\'&a8=\'+ans[7]+\'&a9=\'+ans[8]+\'&a10=\'+ans[9] ,\'_self\' );" >'+
    ...
    function db_query(){
        ...
        var time = document.getElementById("lblCtime").textContent.replace(":", ".");
        var wimg;
        if(last_score===10) wimg='1';
        else if(last_score===9) wimg='2';
        else if(last_score===8) wimg='3';
        ...
        xmlhttp.open("GET", "query.php?score=" + last_score*5 + "&try=" + retry + "&time=" + time + "&wimg=" + wimg +"", true);
        xmlhttp.send();
