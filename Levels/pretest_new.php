<?php
session_start();
//echo $_SESSION['id'].'    '.$_SESSION['pretest'];
?>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>	الاختبار القبلي | حل الألغاز</title>
...
<body dir="rtl"  style="font-family: 'Droid Sans Arabic'; background-image:url('background2020');">
       ...
       <div id="UpdateProgress1" style="display:none;">
        ...
        <nav class=" navbar-expand-lg  navbar navbar-dark bg-primary" style="font-family: 'Droid Sans Arabic'; font-size: x-large">
            <a class="navbar-brand" href="#">المستوى : الاختبار القبلي</a>
    ...
    function get_result()
     {
        ...
        xmlhttp.open("GET", "query_pre.php?score=" + last_score*5 /*+ "&try=" + retry + "&time=" + time*/ , true);
        xmlhttp.send();
